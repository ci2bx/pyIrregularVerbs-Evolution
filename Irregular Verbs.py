...
class Main(Frame):
    ...
    def quitter(self):
        ...
        msg.title('Quitter')
        Label(msg,
              text='Vous �tes s�r de vouloir quitter?',
...
les verbes irreguliers d'Anglais.",
...
Charles a trouve ca sur internet.\n\
    ",bg='black',fg='white').pack(padx=20,pady=10)
...
class Surface(Frame):
    ...
    def __init__(self):
        ...
        #if show == 0 :
        #self.pp = Entry(self,text="Mystere...",
        #                     fg='red')
        #else:     
        ...
        #if show == 0 :
        #self.trd = Entry(self,text="Mystere...",
        #                     fg='blue')
        #else:     
        ...
        Button(self,text='NEW!',command=self.new,
               ...
               activeforeground='blue').grid(row=7,column=1,
                                             columnspan=2,
                                             pady=3)
        Button(self,text='Show',command=lambda *args: showValue(),
               bg='red',fg='blue',relief=RAISED,
               font='bold',activebackground="red",
               activeforeground="blue").grid(row=7,column=2,
                                             columnspan=2,
                                             pady=5)
